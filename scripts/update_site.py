...
def render(publications, arxiv, repositories):
    home = '''<section class="hero"><div><p class="eyebrow">Mathematics · Universidad de Concepción</p><h1>Antonio Laface</h1><p class="position">Full Professor</p><p class="affiliation"><a href="https://dmat-udec.cl/">Departamento de Matemática</a><br><a href="https://cfm.udec.cl/">Facultad de Ciencias Físicas y Matemáticas</a><br><a href="https://www.udec.cl/">Universidad de Concepción</a>, Chile</p><p class="contact"><a href="mailto:antonio.laface@gmail.com">antonio.laface@gmail.com</a><br><a href="tel:+56412203173">+56 41 220 3173</a><br>Casilla 160-C, Concepción, Chile</p></div><figure><img src="/assets/home.jpg" width="600" height="449" alt="Stingrays swimming in clear turquoise water" fetchpriority="high"></figure></section>
